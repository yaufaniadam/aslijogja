        ...
        <?php
            ...
            <div class="row gutter-lg">
                ...
                <div class="main-content">
                    <?php 
                      $produk = get_post($_GET['id_produk']);
                    ?>
                    <!-- Start of Page Header -->
                    <div class="header-umkm">
                        <h1 class="page-title mb-0"><?php the_title(); ?></h1>
                        <a href="<?php echo get_bloginfo('url') . '/produk/'. $produk->post_name; ?>">Lihat Produk</a>
                    </div>
                    <!-- End of Page Header -->
                    <?php
                    if (is_user_logged_in() == true) :
                    ...
                    <div class="post-contents">
                        <form id="post" class="acf-form" action="" method="post">
                            ...
                            <?php acf_form(array(
                                'post_id'       => sanitize_text_field($_GET['id_produk']),
                                'post_title'    => true,
                                'form'          => false,
                                'field_groups' => array('group_61165e89ebca0')
                            )); ?>

                            <div class="acf-form-submit mt-5">
                                <input type="submit" class="acf-button btn btn-primary btn-md btn-ellipse" value="Update Produk">
